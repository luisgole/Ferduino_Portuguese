...
void Salvar_dosadora_EEPROM()
{
  ...
  dosaconfig.segunda_dosagem_personalizada_5_temp = int(segunda_dosagem_personalizada_5);
  ...
  dosaconfig.segunda_dosagem_personalizada_6_temp = int(segunda_dosagem_personalizada_6);
